  ...
  return (
    ...
    >
      {isLoading ? (
        ...
        <QuizBox
          style={{ padding: "50px", backgroundColor: "transparent", color: "#fff" }}
        >
          {noQuestionsAvailable ? (
            ...
            <div>
              <>
               ...
               <h2 className="question-text font-serif text-black">
                     {questions[currentQuestion].title}
                     </h2>
                     <h2 className="question-text  text-gray-500 text-center text-sm">
                     {questions[currentQuestion].originLanguage}
                     </h2>
